...
+ (void)registerForNetworkReachabilityNotifications
{
	[[TWReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[TWReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
